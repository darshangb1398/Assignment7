...
//STEP 1
function halfNumber(input_number){
    return input_number/2;
}
var input_number = parseInt(prompt("Enter a number below :"));
window.console.log("Half of "+input_number+" is "+halfNumber(input_number)+".");
